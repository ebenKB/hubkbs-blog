            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 3:
                  ...
                  msg = 'Congratulations!!! You are almost done with your registration. Please follow this link to complete your' + "account http:hubkbs-blogs.com/user/confirm/".concat(token);
                  resolve(msg);
                  _context2.next = 11;
                  break;
